    ...
    return (
      <Html>
        <Head>
          ...
          <link
            href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800&display=swap&subset=cyrillic"
            rel="stylesheet"
          />
        </Head>
        <body>
          ...
          <script
            noModule
            src="https://unpkg.com/core-js-bundle@3.6.4/index.js"
          />
          <NextScript />
        </body>
      </Html>
